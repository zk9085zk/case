<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Commodity.aspx.cs" Inherits="webs_management_Commodity" %>
<!DOCTYPE html>
...
<body>
     <form id="form1" runat="server">
        ...
        <li><a href="/webs/management/InsertCommodity.aspx">新增商品</a></li>
             ...
             <h1 class="page-header" style="font-family: Microsoft JhengHei">查詢商品</h1>
    ...
    <br />
                     <asp:Button ID="Button1" runat="server" Text="查詢" CssClass="btn btn-info" OnClick="Button1_Click" />
                     <br />
              <br />
