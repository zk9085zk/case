<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Commodity2.aspx.cs" Inherits="webs_management_Commodity" %>
<!DOCTYPE html>
...
<body>
     <form id="form1" runat="server">
        ...
        <li class="active"><a href="/webs/management/Commodity.aspx">商品資料</a></li>
        <li><a href="/webs/management/InsertCommodity.aspx">新增商品</a></li>
                ...
                <br />
                <asp:Button ID="Button2" runat="server" Text="修改" CssClass="btn btn-info" OnClick="Button2_Click" />
                <asp:Button ID="Button3" runat="server" Text="取消" CssClass="btn btn-danger" OnClick="Button3_Click" />
