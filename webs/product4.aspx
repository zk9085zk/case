<%@ Page Language="C#" AutoEventWireup="true" CodeFile="product4.aspx.cs" Inherits="webs_Default4" %>
...
.lab1{
     font:bold;font-size:16px; color:#e8e8e8;
}
.ph-button {
...
<body>
	...
	<!--End-top-nav-script-->
	 ...
	 <div class="col-md-8" style="margin-top:2%;margin-left:3%">
			      ...
			      <h2 style="text-align:center">科技塗裝木紋版系列</h2>
                  ...
                  <p>
                      <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                          ...
                          SelectCommand="SELECT * FROM product WHERE product_class='4'" 
