<%@ Page Language="C#" AutoEventWireup="true" CodeFile="product3.aspx.cs" Inherits="webs_product3" %>
             ...
             <div class="col-md-2" style="margin-top:7%;margin-left:3%">
		        ...
		        <li>
				 ...
				 <div class="col-md-8" style="margin-top:2%;margin-left:3%">	       
			      ...
			      <h2 style="text-align:center">科技木紋版系列</h2>
                  ...
                  <p>
                      <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                          ConnectionString="<%$ ConnectionStrings:boardConnectionString %>" 
                           SelectCommand="SELECT * FROM product WHERE product_class='3'" 
