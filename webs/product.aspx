<%@ Page Language="C#" AutoEventWireup="true" CodeFile="product.aspx.cs" Inherits="webs_product" %>
<!DOCTYPE html>
...
<body>
	...
	<!--End-top-nav-script-->
	 ...
	 <div class="col-md-8" style="margin-top:2%;margin-left:3%">
			      <h2 style="text-align:center">天然木紋版系列</h2>
                    ...
                    <!--  如果需要加回頁籤，於LayoutTemplate的前後頁按鈕中加上 <asp:NumericPagerField /> -->
                  <p>
                      <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                          ConnectionString="<%$ ConnectionStrings:boardConnectionString %>" 
                          SelectCommand="SELECT * FROM product WHERE product_class='1'" 
